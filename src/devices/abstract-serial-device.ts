  ...
  updateState(tick: number): void {
    ...
    switch (this.myState) {
      ...
      case SerialDeviceState.TESTING:
        ...
        break;
      case SerialDeviceState.FAIL:
        break; // this is an end state
      case SerialDeviceState.ERROR:
        break; // this is an end state
      case SerialDeviceState.STALLED:
        break; // this is an end state
      case SerialDeviceState.OK:
        ...
        break;
      default:
        Logger.warn('Unrecognized state : %s', this.myState);
    }
  }
